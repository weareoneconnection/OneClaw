    ...
    try {
      ...
      switch (action) {
        ...
        case "web3.balance": {
          ...
          await context.log(
            `Web3Worker balance requested chain=${chain} address=${address}`,
          );
        ...
        case "web3.tx": {
          ...
          await context.log(
            `Web3Worker tx requested chain=${chain} hash=${hash}`,
          );
        ...
        case "web3.contract.read": {
          ...
          await context.log(
            `Web3Worker contract.read chain=${chain} address=${address} method=${method}`,
          );
        ...
        case "web3.contract.write": {
          ...
          await context.log(
            `Web3Worker contract.write chain=${chain} address=${address} method=${method}`,
          );
        ...
        case "web3.transfer": {
          ...
          await context.log(
            `Web3Worker transfer requested chain=${chain} to=${to}`,
          );

          return notImplemented(action, chain, {
            to,
            amount: amount as Json,
            token: token ?? null,
            from: from ?? null,
          });
        }
      ...
      const message =
        error instanceof Error ? error.message : "Unknown web3 error";
