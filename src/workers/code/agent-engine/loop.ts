import { anthropicLLMClient, getAgentEngineConfig } from "./llm-client.js";
import { buildSystemPrompt } from "./system-prompt.js";
import { executeTool } from "./tools.js";
import { diffAgainstSnapshot, snapshotWorkspace } from "./workspace.js";
import { buildRepoOverview, readProjectConventions } from "./repo-overview.js";
import { deliverAsPullRequest } from "./git-deliver.js";
import type {
  AgentEvent,
  AgentMessage,
  AgentReceipt,
...
export async function runAgentTask(
  ...
  try {
    ...
    // An unverified run is never auto-delivered.
