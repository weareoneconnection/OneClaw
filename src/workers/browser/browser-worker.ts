    ...
    try {
      switch (context.action) {
        case "browser.open": {
          ...
          if (!url) return { ok: false, error: "browser.open requires input.url" };
        ...
        case "browser.click": {
          ...
          if (!selector) return { ok: false, error: "browser.click requires input.selector" };
        ...
        case "browser.type": {
          ...
          if (!selector) return { ok: false, error: "browser.type requires input.selector" };
